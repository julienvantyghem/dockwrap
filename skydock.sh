...
spawn_container "docker.io/crosbymichael/skydns" "skydns" "-d --name skydns -p 127.0.0.1:53:53/udp" "-nameserver 192.168.41.164:53 -domain docker"
spawn_container "docker.io/crosbymichael/skydock" "skydock" "-d -v /var/run/docker.sock:/docker.sock --name skydock" "-ttl 10000000 -environment dev -s /docker.sock -domain docker -name skydns"
